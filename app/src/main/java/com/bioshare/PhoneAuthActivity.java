...
public class PhoneAuthActivity extends CustomActivity implements
    ...
    private Toolbar verifyToolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_phone_auth);

        verifyToolbar = (Toolbar) findViewById(R.id.toolbarPhoneAuth);
...
//        mDetailText = (TextView) findViewById(R.id.detail);
        ...
        String mobile= MyApp.getSharedPrefString("MOBILE");
        mobileNumber.setText(mobile);
        Log.d("phoneauth","mobile"+mobile);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_start_verification:
                ...
                MyApp.spinnerStart(PhoneAuthActivity.this, "Please wait...");
                startPhoneNumberVerification(mPhoneNumberField.getText().toString());
                break;
